...
from splunk_mcp.guardrails import sanitize_output, validate_spl_query
from splunk_mcp.splunk_client import SplunkAPIError, SplunkClient
...
class SplunkService:
    ...
    async def update_settings(self, settings: SplunkSettings) -> None:
        """Replace connection settings and discard any client using old credentials."""
        await self.close()
        self.settings = settings
