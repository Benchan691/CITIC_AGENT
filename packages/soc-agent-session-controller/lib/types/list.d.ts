...
export declare class ApiSessionList {
     ...
     */
    list(allowedIds?: ReadonlySet<string>, signal?: AbortSignal): Promise<SessionSummary[]>;
     ...
     */
    search(query: string, signal: AbortSignal, allowedIds?: ReadonlySet<string>): Promise<SessionSearchValue>;
