...
import type { WorkspaceRemote } from 'dsh-soc-agent-workspace-controller/client'
import type { WorkspaceFollowFrame } from 'dsh-soc-agent-workspace-controller/types'
import type { RemoteFailure, RemoteResult } from '@deepseek-ai/dsh-typert-protocol'
import {
  RemoteStream,
  type RemoteStreamOptions,
} from 'dsh-soc-agent-api-gateway/client'
