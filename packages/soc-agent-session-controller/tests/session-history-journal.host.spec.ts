...
import AgentRegistry, { type Agent, type AssistantStreamFrame } from 'dsh-soc-agent-agent'
...
import { SessionHistoryController } from 'dsh-soc-agent-session-controller/src/history.ts'
import type { SessionFollowFrame, SessionPage, SessionWireEvent } from 'dsh-soc-agent-session-controller/types'
