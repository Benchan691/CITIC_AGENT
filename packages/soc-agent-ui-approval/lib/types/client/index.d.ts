...
export type { ApprovalComposerProps, ApprovalDecision, ApprovalDetailOwnerProps, ApprovalPresentationRequest, ApprovalWireDecision, PendingApproval, } from './contract/slots.ts';
