window.__ModuleLoader__.load({
	id: "dsh-soc-agent-auto-collapse",
	factory: (require) => {
		var module = { exports: {} };
		...
		Schema.object({
			...
			statusText: Schema.string().default("Deep sleeping...")
		});
		//#endregion
		//#region src/client/index.ts
		const inject = ["socClient", "settingsScope"];
		function apply(ctx) {
			if (ctx.get("socClient").surface !== "workspace") return;
			const scope = ctx.settingsScope.bind({ namespace: SOC_AUTO_COLLAPSE_NAMESPACE });
