...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'soc-agent-sidebar: dictionaries')
  ...
  ctx.effect(
    () => ctx.slots.register({
      name: 'sidebar',
      locale: NS,
      // The shell owns geometry; soc-agent-workspace registers the whole browsing
    ...
    'soc-agent-sidebar: slot registration',
  )
