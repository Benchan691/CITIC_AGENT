...
This package is an isolated SOC-owned replacement for the official Harness
sidebar. Its markup and styles are intentionally pinned to the rc.2 visual
baseline; the standard child slots remain available so compatible contributors
can continue to participate without importing the official implementation.
