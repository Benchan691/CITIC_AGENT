window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".eCQNtW_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.eCQNtW_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.eCQNtW_frame{transition:none}}.eCQNtW_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.eCQNtW_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.eCQNtW_handle{cursor:col-resize;z-index:11;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.eCQNtW_frame[data-dragging] .eCQNtW_handle,.eCQNtW_frame[data-rightbar-fullscreen],.eCQNtW_frame[data-rightbar-fullscreen] .eCQNtW_handle,.eCQNtW_frame[data-rightbar-instant],.eCQNtW_frame[data-rightbar-instant] .eCQNtW_handle{transition:none}@media (prefers-reduced-motion:reduce){.eCQNtW_handle{transition:none}}.eCQNtW_rightbarCol{min-width:0;position:relative;overflow:visible}.eCQNtW_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.eCQNtW_overlayLayer>*{pointer-events:auto}";
		const tagId = "dsh-soc-agent-ui-layout/AppFrame.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-soc-agent-ui-layout";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css;
			document.head.appendChild(tag);
		}
		var AppFrame_module_css_default = {
			"centerCol": "eCQNtW_centerCol",
			"frame": "eCQNtW_frame",
			"handle": "eCQNtW_handle",
			"overlayLayer": "eCQNtW_overlayLayer",
			"rightbarCol": "eCQNtW_rightbarCol",
			"sidebarCol": "eCQNtW_sidebarCol"
		};
		//#endregion
