...
import type { ConnectionIndexRequest, ConnectionIndexResponse, ConnectionFetchHandler, HostConnectionFetch, ConnectionRequestRejection, ConnectionTrustRequest, HostConnectionHandle, HostConnectionRpc, SocAuth, SocPrincipal } from './rpc.ts';
...
export declare class HostConnectionService extends Service implements HostConnectionHandle {
     ...
     */
    constructor(ctx: Context, trustedHosts: readonly string[], browserAuth: BrowserAuth, socAuth: SocAuth);
