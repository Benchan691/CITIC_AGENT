window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region ../../node_modules/.pnpm/@deepseek-ai+dsh-llm@0.1.5-rc.2_@deepseek-ai+cordis@4.0.2/node_modules/@deepseek-ai/dsh-llm/lib/types/brand.js
		/**
		...
		*/
		...
		//#endregion
		//#region ../../node_modules/.pnpm/@deepseek-ai+dsh-session@0.1.5-rc.2_@deepseek-ai+cordis@4.0.2_@deepseek-ai+dsh-scope@0._54d1a918d77e481567353c23a9e2039f/node_modules/@deepseek-ai/dsh-session/lib/types/known-event-types.js
		/**
		...
		*  client's signal (timing hook: simulated connection loss). */
		...
		function createFixtureWorld(options) {
			...
			*/
			...
			const workspaceFileTree = /* @__PURE__ */ new Map([
				["", [
					{
						name: ".gitignore",
						type: "file",
