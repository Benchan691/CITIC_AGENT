...
import type { SessionFace } from 'dsh-soc-agent-session-controller/client';
import type { SessionId } from '@deepseek-ai/dsh-session/types';
import type { SnapshotStore } from '@deepseek-ai/dsh-client-store';
import type { ComposerAttachment, ComposerDocument, DraftFileUpload } from './contract/slots.ts';
...
export declare class ConversationController extends Service implements IConversation {
    ...
    private readonly draftAttachmentSessions;
    ...
    private requireDocumentProvider;
