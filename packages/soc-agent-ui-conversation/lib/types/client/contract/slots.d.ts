...
import type { SessionSnapshot } from 'dsh-soc-agent-session-controller/client';
import type { FileUploadReceiptId } from 'dsh-soc-agent-file-upload/client';
...
import type { SessionPendingInteraction } from 'dsh-soc-agent-ui-session/client';
...
export type ComposerAttachment = ComposerImageAttachment | ComposerFileAttachment | ComposerDocument;
...
/** Browser-owned document converted to Markdown by an optional provider. */
