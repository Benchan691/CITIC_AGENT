...
import type { SessionListState, SessionSnapshot } from 'dsh-soc-agent-session-controller/client'
import type { WorkspaceSnapshot, WorkspaceView } from 'dsh-soc-agent-workspace-controller/client'
