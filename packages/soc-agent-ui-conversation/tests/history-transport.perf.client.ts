...
import type {
  ...
  SessionWireEvent,
} from 'dsh-soc-agent-session-controller/types'
import { historyEntries } from 'dsh-soc-agent-session-controller/src/client/sessions/history-records.ts'
import type { SessionEventLikeEntry } from 'dsh-soc-agent-session-controller/client'
import { ConversationNodeAssembler } from 'dsh-soc-agent-ui-conversation/client'
import type {
