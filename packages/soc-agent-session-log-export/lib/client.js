window.__ModuleLoader__.load({
	id: "dsh-soc-agent-session-log-export",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-session-log-export/src/client/HeaderAction.module.css.mjs
		const css = ".N6tm5q_moreButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:28px;flex:none;justify-content:center;align-items:center;padding:6px;display:inline-flex}.N6tm5q_moreButton svg{width:15px;height:15px}.N6tm5q_moreButton:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		const tagId = "dsh-soc-agent-session-log-export/HeaderAction.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-soc-agent-session-log-export";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css;
			document.head.appendChild(tag);
		}
		var HeaderAction_module_css_default = { "moreButton": "N6tm5q_moreButton" };
		//#endregion
