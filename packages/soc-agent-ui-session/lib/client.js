window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region src/client/session-provider.tsx
		...
		*/
		function renderSessionArea(binding, { empty, children }) {
			...
			if (sessionId === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: empty?.() ?? null });
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children }, sessionId);
		}
		//#endregion
