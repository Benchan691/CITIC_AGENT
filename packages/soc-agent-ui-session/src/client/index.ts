...
export class UiSession extends Service {
  ...
  private pendingSnapshot: SessionPendingInteractionSnapshot = new Map()
  ...
  private publishPendingInteractions(): void {
    ...
    // Domains are registered through the declaration-merged public contract.
    // At runtime the base shape is sufficient; the cast reconnects the
    // dynamically assembled map to that compile-time union.
    this.pendingSnapshot = projected as unknown as SessionPendingInteractionSnapshot
