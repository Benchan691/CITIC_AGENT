...
import AgentRegistry, { installModelSelection, type Agent, type ModelSelectionRef } from 'dsh-soc-agent-agent'
...
import { toPiContext } from 'dsh-soc-agent-llm-pi-ai/src/context.ts'
