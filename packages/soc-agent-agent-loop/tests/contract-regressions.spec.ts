...
import AgentRegistry, { type Agent } from 'dsh-soc-agent-agent'
import AgentLoop from 'dsh-soc-agent-agent-loop'
import SessionProjectionRegistry from '@deepseek-ai/dsh-session-projection'
import InvariantRegistry from '@deepseek-ai/dsh-invariants'
import * as SessionInvariant from '@deepseek-ai/dsh-session/invariant'
import * as AgentInvariant from 'dsh-soc-agent-agent/invariant'
import * as AgentLoopInvariant from 'dsh-soc-agent-agent-loop/invariant'
