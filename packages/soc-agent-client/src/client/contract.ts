...
export const SOC_CONFIG_CHANNEL = '/soc-agent-config'
...
export function socSurface(pathname: string): SocClientRuntime['surface'] {
...
export function createSocClientRuntime(
  connection: Pick<ConnectionHandle, 'rpc'>,
  surface: SocClientRuntime['surface'],
): SocClientRuntime {
  return {
    surface,
...
export type SocAdminRootProps =
  & SocAdminContentOwnerProps
  & PropsRenderSlots<'soc.admin.content'>
