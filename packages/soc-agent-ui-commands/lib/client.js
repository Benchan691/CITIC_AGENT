window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const HOST_DESCRIPTION_KEYS = /* @__PURE__ */ new Map([
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-commands/src/client/PopupSelectView.module.css.mjs
		const css = ".ff1-Oa_card{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);min-width:min(220px,100%);max-width:100%;max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;outline:none;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}.ff1-Oa_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.ff1-Oa_row{cursor:pointer;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;display:flex}.ff1-Oa_rowActive{background:var(--dsw-alias-interactive-bg-hover)}.ff1-Oa_label{white-space:nowrap;text-overflow:ellipsis;flex:auto;min-width:0;overflow:hidden}.ff1-Oa_detail{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;overflow:hidden}.ff1-Oa_check{color:var(--dsw-alias-label-primary);flex:none;display:inline-flex}.ff1-Oa_status{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:13px}.ff1-Oa_search{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);background:0 0;border-radius:8px;outline:none;margin:2px 2px 4px;padding:6px 8px;font-size:13px}.ff1-Oa_error{color:var(--dsw-alias-state-error-primary);align-items:center;gap:8px;padding:6px 8px;font-size:12px;display:flex}.ff1-Oa_errorText{text-overflow:ellipsis;flex:1;overflow:hidden}.ff1-Oa_retry{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:6px;padding:2px 8px;font-size:12px}";
		const tagId = "dsh-soc-agent-ui-commands/PopupSelectView.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-soc-agent-ui-commands";
		...
		var PopupSelectView_module_css_default = {
			"card": "ff1-Oa_card",
			"check": "ff1-Oa_check",
			"detail": "ff1-Oa_detail",
			"error": "ff1-Oa_error",
			"errorText": "ff1-Oa_errorText",
			"label": "ff1-Oa_label",
			"retry": "ff1-Oa_retry",
			"row": "ff1-Oa_row",
			"rowActive": "ff1-Oa_rowActive",
			"search": "ff1-Oa_search",
			"status": "ff1-Oa_status",
			"viewport": "ff1-Oa_viewport"
		};
		//#endregion
