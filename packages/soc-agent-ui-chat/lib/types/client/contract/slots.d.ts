...
import type { CommandNode, CompactionSummaryNode, ConversationLocationDataStore, ConversationTurnDataMap, MessageImageLoader, MessageImagesOwnerProps, RenderMessageImages, TurnLocation } from 'dsh-soc-agent-ui-conversation/client';
...
export interface ChatViewInjected {
    hooks: {
        ...
        /** Optional SOC-owned compact-process policy and running label. */
        autoCollapse: SnapshotStore<{
