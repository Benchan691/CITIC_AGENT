window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/MessageItem.module.css.mjs
		const css$15 = ".MyibaW_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.MyibaW_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.MyibaW_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.MyibaW_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.MyibaW_contextRow,.MyibaW_compactionRow{padding:2px 0}.MyibaW_compactionButton{width:100%;height:calc(24px + var(--dsh-content-font-delta,0px));min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.MyibaW_compactionButton:not(:disabled){cursor:pointer}.MyibaW_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.MyibaW_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.MyibaW_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.MyibaW_compactionContextIcon,.MyibaW_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.MyibaW_compactionDisclosureIcon,.MyibaW_compactionButton:not(:disabled):hover .MyibaW_compactionContextIcon,.MyibaW_compactionButton:not(:disabled):focus-visible .MyibaW_compactionContextIcon{opacity:0}.MyibaW_compactionButton:not(:disabled):hover .MyibaW_compactionDisclosureIcon,.MyibaW_compactionButton:not(:disabled):focus-visible .MyibaW_compactionDisclosureIcon{opacity:1}.MyibaW_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.MyibaW_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.MyibaW_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.MyibaW_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.MyibaW_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.MyibaW_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.MyibaW_retrySummary::-webkit-details-marker{display:none}.MyibaW_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.MyibaW_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.MyibaW_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.MyibaW_retryText{color:inherit}.MyibaW_retryRow[data-active] .MyibaW_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite MyibaW_retry-shimmer}.MyibaW_retryRow[open] .MyibaW_retrySummary:after{transform:rotate(45deg)}.MyibaW_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.MyibaW_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.MyibaW_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.MyibaW_turnErrorDot{margin-top:5px}.MyibaW_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.MyibaW_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.MyibaW_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.MyibaW_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.MyibaW_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes MyibaW_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.MyibaW_retryRow[data-active] .MyibaW_retryText{color:inherit;background:0 0;animation:none}}.MyibaW_attachmentRow{flex-wrap:wrap;justify-content:flex-end;gap:8px;max-width:100%;display:flex}.MyibaW_fileCard{border:.5px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-specific-input-major,transparent);box-sizing:border-box;border-radius:16px;flex:0 0 240px;align-items:center;gap:10px;width:240px;min-height:64px;padding:8px 12px;display:inline-flex}.MyibaW_fileIcon{flex:none;width:28px;height:28px}.MyibaW_fileContent{flex-direction:column;flex:1;min-width:0;display:flex}.MyibaW_fileName{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.MyibaW_fileMeta{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-tertiary,#00000073);font-size:12px;line-height:15px;overflow:hidden}";
		const tagId$15 = "dsh-soc-agent-ui-chat/MessageItem.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$15) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-soc-agent-ui-chat";
			tag.dataset.pluginCss = tagId$15;
			tag.textContent = css$15;
			document.head.appendChild(tag);
		}
		var MessageItem_module_css_default = {
			"attachmentRow": "MyibaW_attachmentRow",
			"bubble": "MyibaW_bubble",
			"compactionBody": "MyibaW_compactionBody",
			"compactionButton": "MyibaW_compactionButton",
			"compactionContextIcon": "MyibaW_compactionContextIcon",
			"compactionDisclosureIcon": "MyibaW_compactionDisclosureIcon",
			"compactionLeading": "MyibaW_compactionLeading",
			"compactionRow": "MyibaW_compactionRow",
			"compactionSep": "MyibaW_compactionSep",
			"compactionSummary": "MyibaW_compactionSummary",
			"compactionTitle": "MyibaW_compactionTitle",
			"contextRow": "MyibaW_contextRow",
			"fileCard": "MyibaW_fileCard",
			"fileContent": "MyibaW_fileContent",
			"fileIcon": "MyibaW_fileIcon",
			"fileMeta": "MyibaW_fileMeta",
			"fileName": "MyibaW_fileName",
			"maxTokensTitle": "MyibaW_maxTokensTitle",
			"referenceSummary": "MyibaW_referenceSummary",
			"retry-shimmer": "MyibaW_retry-shimmer",
			"retryDetailLabel": "MyibaW_retryDetailLabel",
			"retryDetails": "MyibaW_retryDetails",
			"retryRow": "MyibaW_retryRow",
			"retrySummary": "MyibaW_retrySummary",
			"retryText": "MyibaW_retryText",
			"turnErrorCode": "MyibaW_turnErrorCode",
			"turnErrorCopy": "MyibaW_turnErrorCopy",
			"turnErrorDot": "MyibaW_turnErrorDot",
			"turnErrorMessage": "MyibaW_turnErrorMessage",
			"turnErrorRow": "MyibaW_turnErrorRow",
			"turnErrorTitle": "MyibaW_turnErrorTitle",
			"userRow": "MyibaW_userRow",
			"userStack": "MyibaW_userStack"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/ContextBody.module.css.mjs
		const css$14 = ".i10DTW_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.i10DTW_fields{border-top:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.i10DTW_field{gap:8px;min-width:0;display:flex}.i10DTW_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.i10DTW_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.i10DTW_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.i10DTW_file{align-items:baseline;gap:6px;min-width:0;display:flex}.i10DTW_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.i10DTW_fileAction{color:var(--dsw-alias-label-caption)}.i10DTW_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.i10DTW_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.i10DTW_entry{gap:8px;min-width:0;display:flex}.i10DTW_entryName{color:var(--dsw-alias-label-secondary);flex:none}.i10DTW_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.i10DTW_sections{flex-direction:column;gap:8px;margin:0;display:flex}.i10DTW_section{flex-direction:column;gap:2px;min-width:0;display:flex}.i10DTW_sectionName{color:var(--dsw-alias-label-caption)}.i10DTW_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.i10DTW_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.i10DTW_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.i10DTW_recall{gap:8px;min-width:0;display:flex}.i10DTW_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.i10DTW_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		const tagId$14 = "dsh-soc-agent-ui-chat/ContextBody.module.css";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "i10DTW_catalogNotice",
			"entries": "i10DTW_entries",
			"entry": "i10DTW_entry",
			"entryDescription": "i10DTW_entryDescription",
			"entryName": "i10DTW_entryName",
			"field": "i10DTW_field",
			"fieldKey": "i10DTW_fieldKey",
			"fieldValue": "i10DTW_fieldValue",
			"fields": "i10DTW_fields",
			"file": "i10DTW_file",
			"fileAction": "i10DTW_fileAction",
			"filePath": "i10DTW_filePath",
			"files": "i10DTW_files",
			"recall": "i10DTW_recall",
			"recallCounts": "i10DTW_recallCounts",
			"recallLabel": "i10DTW_recallLabel",
			"recalls": "i10DTW_recalls",
			"relaySender": "i10DTW_relaySender",
			"section": "i10DTW_section",
			"sectionName": "i10DTW_sectionName",
			"sectionText": "i10DTW_sectionText",
			"sections": "i10DTW_sections",
			"text": "i10DTW_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/ContextInjectionRow.module.css.mjs
		const css$13 = ".tXeVIG_root{min-width:0}.tXeVIG_root[data-open]{padding-bottom:4px}.tXeVIG_chevron{color:var(--dsw-alias-label-secondary)}.tXeVIG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.tXeVIG_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.tXeVIG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.tXeVIG_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		const tagId$13 = "dsh-soc-agent-ui-chat/ContextInjectionRow.module.css";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "tXeVIG_body",
			"chevron": "tXeVIG_chevron",
			"root": "tXeVIG_root",
			"sep": "tXeVIG_sep",
			"source": "tXeVIG_source",
			"summary": "tXeVIG_summary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/MessageIconActions.module.css.mjs
		const css$12 = "._8g76sa_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:8px;display:flex}._8g76sa_timeStart{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}._8g76sa_timeEnd{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap}@media (hover:hover){[data-actions-reveal=hover] ._8g76sa_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])) ._8g76sa_actions{opacity:0;transition:opacity 80ms}[data-actions-reveal=hover]:hover ._8g76sa_actions,[data-actions-reveal=hover]:focus-within ._8g76sa_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):hover ._8g76sa_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):focus-within ._8g76sa_actions{opacity:1}}._8g76sa_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}._8g76sa_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}._8g76sa_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}._8g76sa_action[data-unavailable]{cursor:default;opacity:.4}._8g76sa_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}._8g76sa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		const tagId$12 = "dsh-soc-agent-ui-chat/MessageIconActions.module.css";
		...
		var MessageIconActions_module_css_default = {
			"action": "_8g76sa_action",
			"actions": "_8g76sa_actions",
			"timeEnd": "_8g76sa_timeEnd",
			"timeStart": "_8g76sa_timeStart",
			"visuallyHidden": "_8g76sa_visuallyHidden"
		};
		//#endregion
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						showBubble && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, _deepseek_ai_dsh_client_ui_primitives.projectUserText)(text, referenceLabels, skillNames), rest.map((block, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.JsonBlock, {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/ChatView.module.css.mjs
		const css$11 = "._8S2gdW_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}._8S2gdW_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] ._8S2gdW_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] ._8S2gdW_scroll{flex:none;min-height:auto;overflow:visible}._8S2gdW_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}._8S2gdW_column>:not([hidden]):not(._8S2gdW_flowItem:empty)~:not([hidden]):not(._8S2gdW_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}._8S2gdW_flowItem{min-width:0}._8S2gdW_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}._8S2gdW_flowItem:empty{display:none}._8S2gdW_callRow{border-radius:6px}._8S2gdW_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite _8S2gdW_dsh-turn-status-shimmer;display:inline-flex}._8S2gdW_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes _8S2gdW_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){._8S2gdW_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}._8S2gdW_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._8S2gdW_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._8S2gdW_older{justify-content:center;display:flex}._8S2gdW_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}._8S2gdW_older button:disabled{cursor:default;opacity:.6}._8S2gdW_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] ._8S2gdW_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}._8S2gdW_toBottom{--dsw-elevation-stroke-color:var(--dsw-alias-border-l3);corner-shape:round;width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-elevation-panel);cursor:pointer;pointer-events:auto;border:0;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}._8S2gdW_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}._8S2gdW_modalAction{min-width:72px}";
		const tagId$11 = "dsh-soc-agent-ui-chat/ChatView.module.css";
		...
		var ChatView_module_css_default = {
			"callRow": "_8S2gdW_callRow",
			"column": "_8S2gdW_column",
			"dsh-turn-status-shimmer": "_8S2gdW_dsh-turn-status-shimmer",
			"flowItem": "_8S2gdW_flowItem",
			"hint": "_8S2gdW_hint",
			"modalAction": "_8S2gdW_modalAction",
			"older": "_8S2gdW_older",
			"openError": "_8S2gdW_openError",
			"root": "_8S2gdW_root",
			"scroll": "_8S2gdW_scroll",
			"toBottom": "_8S2gdW_toBottom",
			"toBottomSlot": "_8S2gdW_toBottomSlot",
			"turnStatus": "_8S2gdW_turnStatus",
			"turnStatusClock": "_8S2gdW_turnStatusClock"
		};
		//#endregion
		...
		const PRESERVED_EMAIL_DRAFT_TOOLS = /* @__PURE__ */ new Set([
			"mcp__soc_agent__zimbra_send_email",
			"mcp__soc_agent__zimbra_forward_email",
			"mcp__soc_agent__zimbra_use_signature_on_email"
		]);
		function preservesDraftTool(node) {
			if (node?.kind !== "tool-call") return false;
			const root = node.data.root;
			const name = "kind" in root ? root.call?.name : root.name;
			return name !== null && name !== void 0 && PRESERVED_EMAIL_DRAFT_TOOLS.has(name);
		}
		...
		const ChatNodeSeat = (0, react.memo)(function ChatNodeSeat({ nodeKey, useChatNode, useChatNodeProcess, historyIncomplete, compactTranscript, cwd, openFile, inspectCall, forkAt, loadImage, renderMessageImages, fileMentions, useStore, actions, renderSlot, t }) {
			...
			const processMember = routedNode !== void 0 && processWindowReady && !TURN_PROCESS_INDEPENDENT_KINDS.has(routedNode.kind) && routedNode.anchorSeq >= processSpec.processStartSeq && routedNode.anchorSeq < processSpec.answerAnchorSeq && !preservesDraftTool(routedNode);
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/TurnNavigator.module.css.mjs
		const css$10 = ".gRBs0G_slot{z-index:7;pointer-events:none;height:0;position:sticky;top:0}.gRBs0G_frame{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:100px;top:calc(var(--turn-rail-band) / 2);right:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}.gRBs0G_scroller{overscroll-behavior:contain;scrollbar-width:none;position:absolute;inset:0;overflow-y:auto}.gRBs0G_scroller::-webkit-scrollbar{display:none}.gRBs0G_fadeTop{mask-image:linear-gradient(#0000 0,#000 24px 100%)}.gRBs0G_fadeBottom{mask-image:linear-gradient(#000 0 calc(100% - 24px),#0000 100%)}.gRBs0G_fadeTop.gRBs0G_fadeBottom{mask-image:linear-gradient(#0000 0,#000 24px calc(100% - 24px),#0000 100%)}.gRBs0G_marks{height:var(--turn-natural-height);position:relative}.gRBs0G_markPosition{top:calc(var(--turn-natural-position) + var(--turn-rail-inset));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out gRBs0G_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}.gRBs0G_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 0 0 auto}.gRBs0G_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;right:0;transform:translateY(-50%)}.gRBs0G_markUnloaded:before{opacity:.6;width:8px}.gRBs0G_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}.gRBs0G_markBusy:before{animation:1s ease-in-out infinite gRBs0G_dsh-turn-mark-busy}.gRBs0G_markActive:before{background:var(--dsw-alias-label-primary);width:20px}.gRBs0G_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}.gRBs0G_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.gRBs0G_preview{top:clamp(0px, calc(var(--turn-natural-position) + var(--turn-rail-inset) - var(--turn-scroll-top,0px) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-elevation-panel);pointer-events:none;border:0;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out gRBs0G_dsh-turn-preview-enter;position:absolute;right:calc(100% + 10px);overflow:hidden}.gRBs0G_previewPrompt,.gRBs0G_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.gRBs0G_previewPrompt{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:1}.gRBs0G_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:3;margin-top:4px}@keyframes gRBs0G_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes gRBs0G_dsh-turn-preview-enter{0%{opacity:0;transform:translate(4px)}to{opacity:1;transform:translate(0)}}@keyframes gRBs0G_dsh-turn-mark-busy{0%,to{opacity:1}50%{opacity:.35}}@container (width<=900px){.gRBs0G_slot{display:none}}@media (prefers-reduced-motion:reduce){.gRBs0G_frame,.gRBs0G_scroller,.gRBs0G_markPosition,.gRBs0G_mark:before,.gRBs0G_markBusy:before,.gRBs0G_preview{scroll-behavior:auto;transition:none;animation:none}}";
		const tagId$10 = "dsh-soc-agent-ui-chat/TurnNavigator.module.css";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-busy": "gRBs0G_dsh-turn-mark-busy",
			"dsh-turn-mark-enter": "gRBs0G_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "gRBs0G_dsh-turn-preview-enter",
			"fadeBottom": "gRBs0G_fadeBottom",
			"fadeTop": "gRBs0G_fadeTop",
			"frame": "gRBs0G_frame",
			"mark": "gRBs0G_mark",
			"markActive": "gRBs0G_markActive",
			"markBusy": "gRBs0G_markBusy",
			"markPosition": "gRBs0G_markPosition",
			"markPreview": "gRBs0G_markPreview",
			"markUnloaded": "gRBs0G_markUnloaded",
			"marks": "gRBs0G_marks",
			"preview": "gRBs0G_preview",
			"previewPrompt": "gRBs0G_previewPrompt",
			"previewResponse": "gRBs0G_previewResponse",
			"scroller": "gRBs0G_scroller",
			"slot": "gRBs0G_slot"
		};
		//#endregion
		...
		*/
		...
		function TurnStatus({ startTime, statusText, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				role: "status",
				"aria-live": "polite",
				children: [statusText || t("chat.deepDiving"), showClock && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		const ChatNodeList = (0, react.memo)(function ChatNodeList({ order, ...seatProps }) {
			return order.map((nodeKey) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatNodeSeat, {
				nodeKey,
				...seatProps
			}, nodeKey));
		});
		...
		*/
		function ChatView({ useSession, useChat, useChatNode, useChatNodeProcess, useSessions, useStore, actions, renderSlot, sessionId, openFile, loadOlder, loadThrough, loadImage, openView, chatScroll, forkAt, fileMentions, useTranscriptView, useAutoCollapse = useDisabledAutoCollapse, useProjection, t }) {
			...
			const autoCollapse = useAutoCollapse((value) => value);
			const compactTranscript = useTranscriptView((mode) => mode === "compact") && autoCollapse.enabled;
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatNodeList, {
									order,
									useChatNode,
									useChatNodeProcess,
								...
								running && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TurnStatus, {
									...
									statusText: autoCollapse.statusText,
									t
								}),
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/accessibility.module.css.mjs
		const css$9 = "._4BEiGa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		const tagId$9 = "dsh-soc-agent-ui-chat/accessibility.module.css";
		...
		var accessibility_module_css_default = { "visuallyHidden": "_4BEiGa_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/ReasoningRow.module.css.mjs
		const css$8 = ".yEcekG_root{flex-direction:column;display:flex}.yEcekG_root:not([data-expanded]){contain:size layout;height:calc(24px + var(--dsh-content-font-delta,0px))}.yEcekG_row{position:relative;overflow:hidden}.yEcekG_root[data-state=running] .yEcekG_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite yEcekG_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes yEcekG_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}.yEcekG_leading{flex-shrink:0}.yEcekG_chevron{color:var(--dsw-alias-label-secondary)}.yEcekG_title{font-weight:400}.yEcekG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.yEcekG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:nowrap;flex:auto;overflow:hidden}.yEcekG_summaryText{text-overflow:ellipsis;display:block;overflow:hidden}.yEcekG_summary[data-follow-end]{justify-content:flex-end;display:flex}.yEcekG_summary[data-follow-end] .yEcekG_summaryText{text-align:start;text-overflow:clip;flex:none;width:max-content;min-width:100%;overflow:visible}.yEcekG_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:pre-wrap;word-break:break-word}@media (prefers-reduced-motion:reduce){.yEcekG_root[data-state=running] .yEcekG_row:after{animation:none}}";
		const tagId$8 = "dsh-soc-agent-ui-chat/ReasoningRow.module.css";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "yEcekG_chevron",
			"dsh-reasoning-row-sweep": "yEcekG_dsh-reasoning-row-sweep",
			"leading": "yEcekG_leading",
			"root": "yEcekG_root",
			"row": "yEcekG_row",
			"separator": "yEcekG_separator",
			"summary": "yEcekG_summary",
			"summaryText": "yEcekG_summaryText",
			"thinkBody": "yEcekG_thinkBody",
			"title": "yEcekG_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/AssistantMarkdown.module.css.mjs
		const css$7 = ".MxI6yG_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.MxI6yG_body{flex-direction:column;gap:16px;display:flex}.MxI6yG_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.MxI6yG_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.MxI6yG_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.MxI6yG_actions{margin-top:16px;margin-left:-6px}";
		const tagId$7 = "dsh-soc-agent-ui-chat/AssistantMarkdown.module.css";
		...
		var AssistantMarkdown_module_css_default = {
			"actions": "MxI6yG_actions",
			"body": "MxI6yG_body",
			"root": "MxI6yG_root",
			"stopped": "MxI6yG_stopped"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/GenericCommandCard.module.css.mjs
		const css$6 = "._3uLqqa_root{flex-direction:column;display:flex}._3uLqqa_row{position:relative;overflow:hidden}._3uLqqa_root[data-state=running] ._3uLqqa_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _3uLqqa_dsh-command-row-sweep;position:absolute;left:0}@keyframes _3uLqqa_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}._3uLqqa_leading{flex-shrink:0}._3uLqqa_chevron{color:var(--dsw-alias-label-secondary)}._3uLqqa_title{font-weight:400}._3uLqqa_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._3uLqqa_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}._3uLqqa_summary[data-error],._3uLqqa_body[data-error]{color:var(--dsw-alias-state-error-primary)}._3uLqqa_body{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){._3uLqqa_root[data-state=running] ._3uLqqa_row:after{animation:none}}";
		const tagId$6 = "dsh-soc-agent-ui-chat/GenericCommandCard.module.css";
		...
		var GenericCommandCard_module_css_default = {
			"body": "_3uLqqa_body",
			"chevron": "_3uLqqa_chevron",
			"dsh-command-row-sweep": "_3uLqqa_dsh-command-row-sweep",
			"leading": "_3uLqqa_leading",
			"root": "_3uLqqa_root",
			"row": "_3uLqqa_row",
			"separator": "_3uLqqa_separator",
			"summary": "_3uLqqa_summary",
			"title": "_3uLqqa_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/TurnProcessNodeView.module.css.mjs
		const css$5 = "._4beB5G_root{box-sizing:border-box;border:none;border-bottom:.5px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}._4beB5G_root:not([data-open]){margin-bottom:8px}._4beB5G_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}._4beB5G_root[data-open] ._4beB5G_chevron{transform:rotate(0)}._4beB5G_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){._4beB5G_chevron{transition:none}}";
		const tagId$5 = "dsh-soc-agent-ui-chat/TurnProcessNodeView.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/TurnUsagePanel.module.css.mjs
		const css$4 = ".vTCGBW_root{min-width:0;display:inline-flex}.vTCGBW_root+.vTCGBW_root{margin-left:-6px}.vTCGBW_trigger{min-width:0;height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:28px;align-items:center;gap:4px;padding:6px 8px;display:inline-flex}.vTCGBW_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.vTCGBW_trigger svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px));flex:none}.vTCGBW_trigger:hover,.vTCGBW_trigger[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}@media (width<=480px){.vTCGBW_trigger{width:calc(28px + var(--dsh-content-font-delta,0px));justify-content:center;padding:6px}.vTCGBW_trigger .vTCGBW_label{display:none}.vTCGBW_root+.vTCGBW_root{margin-left:0}}";
		const tagId$4 = "dsh-soc-agent-ui-chat/TurnUsagePanel.module.css";
		...
		var TurnUsagePanel_module_css_default = {
			"label": "vTCGBW_label",
			"root": "vTCGBW_root",
			"trigger": "vTCGBW_trigger"
		};
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/stat-dialog.module.css.mjs
		const css$3 = ".Messxq_panel{z-index:1100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(300px,100vw - 24px);max-width:min(440px,100vw - 24px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-secondary);cursor:default;border:0;border-radius:12px;padding:16px;font-size:12px;line-height:18px;position:fixed}.Messxq_title{color:var(--dsw-alias-label-primary);justify-content:space-between;gap:16px;margin-bottom:8px;font-weight:500;display:flex}.Messxq_titleRule{border-top:.5px solid var(--dsw-alias-border-l2);margin-bottom:10px}.Messxq_titleValue{font-variant-numeric:tabular-nums}.Messxq_titleLabel{align-items:center;gap:6px;min-width:0;display:inline-flex}.Messxq_titleLabel svg{flex:none;width:14px;height:14px}.Messxq_details{color:var(--dsw-alias-label-tertiary);grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;margin:0;display:grid}.Messxq_details dt,.Messxq_details dd{min-width:0;margin:0}.Messxq_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}.Messxq_details .Messxq_route{overflow-wrap:anywhere}.Messxq_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}";
		const tagId$3 = "dsh-soc-agent-ui-chat/stat-dialog.module.css";
		...
		var stat_dialog_module_css_default = {
			"details": "Messxq_details",
			"panel": "Messxq_panel",
			"reasoning": "Messxq_reasoning",
			"route": "Messxq_route",
			"title": "Messxq_title",
			"titleLabel": "Messxq_titleLabel",
			"titleRule": "Messxq_titleRule",
			"titleValue": "Messxq_titleValue"
		};
		//#endregion
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDatabaseOutline16, {}), t("message.turnUsage.title")]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: stat_dialog_module_css_default.titleLabel,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconClockOutline16, {}), t("message.turnTime.title")]
							})
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: stat_dialog_module_css_default.titleRule,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("message.turnTime.duration") }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatRunDuration(runMs, t) }),
								tokensPerSecond !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("message.turnTime.speed") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("message.tokensPerSecond", { tps: formatTokensPerSecond(tokensPerSecond) }) })] }),
								ttftMs !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("message.turnTime.ttft") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("duration.seconds", { seconds: formatLatencySeconds(ttftMs) }) })] })
							]
						})
					]
				}), document.body)]
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/TurnTailNodeView.module.css.mjs
		const css$2 = "._7JeLKa_root{flex-direction:column;gap:16px;display:flex}._7JeLKa_actions{margin-top:4px;margin-left:-6px}";
		const tagId$2 = "dsh-soc-agent-ui-chat/TurnTailNodeView.module.css";
		...
		const TurnTailNodeView = (0, react.memo)(function TurnTailNodeView({ node, openFile, forkAt, renderSlot, renderSlotChain, t, useChat }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [tail, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MessageIconActions, {
					...
					usageAction: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [data.tokenUsage !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TurnUsagePanel, {
						usage: data.tokenUsage,
						t
					}), runMs !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TurnTimePanel, {
						runMs,
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/chat/StatsPills.module.css.mjs
		const css$1 = ".Q_qt9W_root{max-width:var(--dsh-chat-content-width);box-sizing:border-box;width:100%;padding:4px calc(var(--dsh-composer-side-clearance) + 16px) 0px;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));justify-content:center;gap:12px;margin:0 auto;display:flex}.Q_qt9W_anchor{min-width:0;display:inline-flex}.Q_qt9W_pill{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;font-variant-numeric:tabular-nums;line-height:inherit;white-space:nowrap;background:0 0;border:none;border-radius:24px;align-items:center;gap:6px;padding:1px 8px;display:inline-flex}.Q_qt9W_pill svg{flex:none;width:14px;height:14px}button.Q_qt9W_pill{cursor:pointer}button.Q_qt9W_pill:hover,button.Q_qt9W_pill[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Q_qt9W_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.Q_qt9W_sep{color:var(--dsw-alias-separator-primary);margin:0 6px}";
		const tagId$1 = "dsh-soc-agent-ui-chat/StatsPills.module.css";
		...
		function TimePill({ stats, t, dialog }) {
			...
			if (stats.llmMs <= 0 && stats.toolMs <= 0 && stats.ttftSteps <= 0 && stats.decodeMs <= 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconGaugeOutline16, {}), label]
				})
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				ref: rootRef,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: stat_dialog_module_css_default.titleLabel,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconGaugeOutline16, {}), t("stats.dialog.title")]
							})
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: stat_dialog_module_css_default.titleRule,
		...
		function UsagePill({ usage, t, dialog }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDatabaseOutline16, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: StatsPills_module_css_default.label,
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: stat_dialog_module_css_default.titleLabel,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDatabaseOutline16, {}), t("stats.dialog.usageTitle")]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: stat_dialog_module_css_default.titleValue,
		...
		*/
		...
		//#endregion
		//#region ../../node_modules/.pnpm/@deepseek-ai+dsh-session@0.1.5-rc.2_@deepseek-ai+cordis@4.0.2_@deepseek-ai+dsh-scope@0._54d1a918d77e481567353c23a9e2039f/node_modules/@deepseek-ai/dsh-session/lib/types/surface.js
		...
		*/
		...
		//#endregion
		//#region ../../node_modules/.pnpm/@deepseek-ai+dsh-llm@0.1.5-rc.2_@deepseek-ai+cordis@4.0.2/node_modules/@deepseek-ai/dsh-llm/lib/types/assistant-stream.js
		/**
		...
		*/
		...
		//#endregion
		//#region ../../node_modules/.pnpm/@deepseek-ai+dsh-token-meter@0.1.5-rc.2_b0610af242b1c95b80c4d1b750321823/node_modules/@deepseek-ai/dsh-token-meter/lib/types/turn-usage.js
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-chat/src/client/settings/TranscriptViewRow.module.css.mjs
		const css = ".czjQyG_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.czjQyG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.czjQyG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.czjQyG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.czjQyG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.czjQyG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.czjQyG_chevron{flex:none}";
		const tagId = "dsh-soc-agent-ui-chat/TranscriptViewRow.module.css";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "czjQyG_chevron",
			"desc": "czjQyG_desc",
			"row": "czjQyG_row",
			"rowText": "czjQyG_rowText",
			"selector": "czjQyG_selector",
			"title": "czjQyG_title"
		};
		//#endregion
		...
		*/
		function apply(ctx) {
			...
			const autoCollapse = ctx.get("socAutoCollapse")?.state ?? (0, _deepseek_ai_dsh_client_store.createSnapshotStore)({
				enabled: false,
				statusText: ""
			});
