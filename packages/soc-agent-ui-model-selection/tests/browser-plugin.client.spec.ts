...
import { createScope } from 'dsh-soc-agent-session-controller/client'
import type { SessionId } from '@deepseek-ai/dsh-session/types'
import { LocaleRuntime } from '@deepseek-ai/dsh-client-locale/client'
import { createSnapshotStore, type SnapshotStore } from '@deepseek-ai/dsh-client-store'
import { TestRemote } from '@deepseek-ai/dsh-client-test-runtime'
import type { ModelSelection, ModelSelectionProjection } from 'dsh-soc-agent-session-controller/types'
import type { CommandContribution, PopupSelectSpec, SelectOption } from 'dsh-soc-agent-ui-commands/client'
