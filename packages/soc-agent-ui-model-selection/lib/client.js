window.__ModuleLoader__.load({
	id: "dsh-soc-agent-ui-model-selection",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".Oqllyq_root{min-width:0;position:relative}.Oqllyq_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.Oqllyq_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Oqllyq_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.Oqllyq_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Oqllyq_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Oqllyq_triggerEffort{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-caption);flex-shrink:1000;overflow:hidden}.Oqllyq_triggerIcon{flex:none;display:none}@container (width<=360px){.Oqllyq_triggerIcon{display:block}.Oqllyq_triggerLabel,.Oqllyq_triggerEffort{display:none}}.Oqllyq_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.Oqllyq_chevronOpen{transform:rotate(180deg)}.Oqllyq_menu{z-index:1100;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:hidden}.Oqllyq_status,.Oqllyq_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.Oqllyq_error,.Oqllyq_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.Oqllyq_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.Oqllyq_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.Oqllyq_groups{min-height:0;overflow-y:auto}.Oqllyq_group+.Oqllyq_group{margin-top:4px}.Oqllyq_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.Oqllyq_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.Oqllyq_option:hover:not(:disabled),.Oqllyq_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.Oqllyq_selected{background:0 0}.Oqllyq_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Oqllyq_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Oqllyq_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.Oqllyq_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.Oqllyq_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.Oqllyq_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.Oqllyq_cellLabel{white-space:nowrap;flex:none}.Oqllyq_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.Oqllyq_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		const tagId = "dsh-soc-agent-ui-model-selection/ModelSelect.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-soc-agent-ui-model-selection";
		...
		var ModelSelect_module_css_default = {
			"cell": "Oqllyq_cell",
			"cellChevron": "Oqllyq_cellChevron",
			"cellLabel": "Oqllyq_cellLabel",
			"cellValue": "Oqllyq_cellValue",
			"check": "Oqllyq_check",
			"chevron": "Oqllyq_chevron",
			"chevronOpen": "Oqllyq_chevronOpen",
			"empty": "Oqllyq_empty",
			"error": "Oqllyq_error",
			"group": "Oqllyq_group",
			"groupTitle": "Oqllyq_groupTitle",
			"groups": "Oqllyq_groups",
			"menu": "Oqllyq_menu",
			"modelName": "Oqllyq_modelName",
			"option": "Oqllyq_option",
			"optionCopy": "Oqllyq_optionCopy",
			"retry": "Oqllyq_retry",
			"root": "Oqllyq_root",
			"selected": "Oqllyq_selected",
			"status": "Oqllyq_status",
			"trigger": "Oqllyq_trigger",
			"triggerEffort": "Oqllyq_triggerEffort",
			"triggerIcon": "Oqllyq_triggerIcon",
			"triggerLabel": "Oqllyq_triggerLabel",
			"warning": "Oqllyq_warning"
		};
		//#endregion
