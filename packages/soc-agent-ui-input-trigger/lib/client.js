window.__ModuleLoader__.load({
	id: "dsh-soc-agent-ui-input-trigger",
	factory: (require) => {
		var module = { exports: {} };
		...
		//#region ../../node_modules/.pnpm/@deepseek-ai+dsh-file-reference@0.1.5-rc.2_@deepseek-ai+cordis@4.0.2_@deepseek-ai+dsh-a_a75a825149094c14f94307dc05d8221c/node_modules/@deepseek-ai/dsh-file-reference/lib/types/grammar.js
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chankokpan/Documents/CITIC_AGENT/packages/soc-agent-ui-input-trigger/src/client/MenuView.module.css.mjs
		const css = ".GEDWGa_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.GEDWGa_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.GEDWGa_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.GEDWGa_item.GEDWGa_active{background:var(--dsw-alias-interactive-bg-hover)}.GEDWGa_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.GEDWGa_sectionTitle:not(:first-child){margin-top:4px}.GEDWGa_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.GEDWGa_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.GEDWGa_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.GEDWGa_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.GEDWGa_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.GEDWGa_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.GEDWGa_item.GEDWGa_active .GEDWGa_drillHintText,.GEDWGa_item.GEDWGa_active .GEDWGa_drillHint{display:inline-flex}.GEDWGa_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.GEDWGa_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.GEDWGa_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.GEDWGa_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.GEDWGa_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite GEDWGa_dsh-menu-skeleton}@keyframes GEDWGa_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.GEDWGa_crumbs{border-bottom:.5px solid var(--dsw-alias-border-l1);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 4px 6px;display:flex}.GEDWGa_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.GEDWGa_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.GEDWGa_crumbCurrent,.GEDWGa_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.GEDWGa_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		const tagId = "dsh-soc-agent-ui-input-trigger/MenuView.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-soc-agent-ui-input-trigger";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css;
			document.head.appendChild(tag);
		}
		var MenuView_module_css_default = {
			"active": "GEDWGa_active",
			"crumb": "GEDWGa_crumb",
			"crumbCurrent": "GEDWGa_crumbCurrent",
			"crumbSeparator": "GEDWGa_crumbSeparator",
			"crumbs": "GEDWGa_crumbs",
			"drill": "GEDWGa_drill",
			"drillHint": "GEDWGa_drillHint",
			"drillHintText": "GEDWGa_drillHintText",
			"dsh-menu-skeleton": "GEDWGa_dsh-menu-skeleton",
			"groupTitle": "GEDWGa_groupTitle",
			"item": "GEDWGa_item",
			"itemDescription": "GEDWGa_itemDescription",
			"itemIcon": "GEDWGa_itemIcon",
			"itemName": "GEDWGa_itemName",
			"menu": "GEDWGa_menu",
			"sectionTitle": "GEDWGa_sectionTitle",
			"skeletonBar": "GEDWGa_skeletonBar",
			"skeletonRow": "GEDWGa_skeletonRow",
			"trailing": "GEDWGa_trailing",
			"viewport": "GEDWGa_viewport"
		};
		//#endregion
		...
		function MenuView({ menu, headers, onPick, onCrumb, onHover, onDismiss, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [state.groups.map((group) => {
					...
					return trail === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("nav", {
						className: MenuView_module_css_default.crumbs,
						"aria-label": t("crumbs.aria"),
						children: trail.map((crumb, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [index > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: state.groups.map((group) => group.status === "ready" && group.items.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [group.showGroupTitle === false || group.items.some((item) => item.section !== void 0) ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: MenuView_module_css_default.groupTitle,
						role: "presentation",
						"data-source": group.source,
						children: t(group.source)
					}), group.status === "pending" && group.items.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						role: "status",
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [item.section !== void 0 && item.section !== group.items[index - 1]?.section ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								item.drill === true && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
