...
import { createScope, scopeOf } from 'dsh-soc-agent-session-controller/client'
import { SlotRegistry } from 'dsh-soc-agent-ui-renderer/client'
import type { SessionId } from '@deepseek-ai/dsh-session/types'
import { apply, inject, InputTriggerService } from 'dsh-soc-agent-ui-input-trigger/client'
import type { MenuViewInjected } from 'dsh-soc-agent-ui-input-trigger/client'
