 ...
 */
declare function resolveSpec(config: Config): ResolvedSpec;
/** File-backed settings provider (`settings.yaml`/`.json`). */
declare class FileSettingsProvider extends SettingsProvider {
  config: Config;
...
//#endregion
export { Config, FileSettingsProvider, FileSettingsProvider as default, resolveSpec };