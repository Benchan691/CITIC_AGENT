	...
	factory: (require) => {
		...
		*/
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			...
			tag.dataset.plugin = "dsh-soc-agent-workspace";
		...
		var Rows_module_css_default = {
			"arrow": "bBgwEW_arrow",
			"arrowOpen": "bBgwEW_arrowOpen",
			"chevron": "bBgwEW_chevron",
			"dot": "bBgwEW_dot",
			"dropAfter": "bBgwEW_dropAfter",
			"dropBefore": "bBgwEW_dropBefore",
			"flatSessionRowWithoutStatus": "bBgwEW_flatSessionRowWithoutStatus",
			"folder": "bBgwEW_folder",
			"folderActive": "bBgwEW_folderActive",
			"hoverContent": "bBgwEW_hoverContent",
			"hoverPath": "bBgwEW_hoverPath",
			"hoverStatus": "bBgwEW_hoverStatus",
			"hoverTime": "bBgwEW_hoverTime",
			"hoverTitle": "bBgwEW_hoverTitle",
			"iconButton": "bBgwEW_iconButton",
			"menuOpen": "bBgwEW_menuOpen",
			"meta": "bBgwEW_meta",
			"projectRow": "bBgwEW_projectRow",
			"projectText": "bBgwEW_projectText",
			...
			"time": "bBgwEW_time",
			"title": "bBgwEW_title",
			"visuallyHidden": "bBgwEW_visuallyHidden"
		};
		//#endregion
		...
		*/
		function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, onPick, onClose, addOnly = false, side = "bottom", selectedId }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				open && !addIsTheOnlyEntry && workspaceSnapshot.phase === "pending" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProjectRowItem, {
										...
										actions: group.workspaceId === void 0 ? void 0 : workspaces.find((item) => item.workspaceId === group.workspaceId)?.title === "General" ? {
											clear: () => {
												const workspace = workspaces.find((item) => item.workspaceId === group.workspaceId);
												if (group.workspaceId !== void 0) onClearRequest(group.workspaceId, group.label, workspace?.sessionIds ?? []);
											},
		...
		*/
		function WorkspaceBrowser({ wide, expandSidebar, useSessions, useWorkspaces, useStore, actions, startSession, open, renameSession, deleteSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, insertSessionBefore, createWorkspace, searchSessions, searchResultLimit, t }) {
			...
			const [sessionDeleteCommittedId, setSessionDeleteCommittedId] = (0, react.useState)(null);
			...
			const onSessionDelete = (sessionId, currentTitle) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						...
						footer: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							...
							children: t("clear.sessions")
						})] }),
						children: [clearTarget !== null && (clearing || clearTarget.deletedCount > 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: WorkspaceBrowser_module_css_default.deleteStatus,
							role: "status",
		...
		*/
		...
		const zh = {
			...
			"clear.progress": "已清除 {done}/{n} 个会话。",
			"delete.session": "删除会话",
			"delete.session.desc": "删除“{name}”？这将永久删除此会话及其消息。",
		...
		const en = {
			...
			"clear.progress": "Cleared {done} of {n} sessions.",
			"delete.session": "Delete session",
			"delete.session.desc": "Delete “{name}”? This permanently deletes this session and its messages.",
