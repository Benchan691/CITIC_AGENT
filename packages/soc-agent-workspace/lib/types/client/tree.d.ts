 ...
 * remains visible.
 */
import { type SessionListState, type SessionSearchResultItem } from 'dsh-soc-agent-session-controller/client';
import type { WorkspaceId, WorkspaceView } from 'dsh-soc-agent-workspace-controller/client';
import type { SessionPendingInteractionBase } from 'dsh-soc-agent-ui-session/client';
