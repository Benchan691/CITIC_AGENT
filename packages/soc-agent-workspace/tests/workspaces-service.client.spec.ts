...
import type { ClientRemote, DirectoryListing } from 'dsh-soc-agent-api-remotes/client'
import { RemoteError } from '@deepseek-ai/dsh-client-test-runtime'
import type { RemoteResult } from 'dsh-soc-agent-api-remotes/client'
import { SessionId } from '@deepseek-ai/dsh-session/types'
import { LayoutController } from 'dsh-soc-agent-ui-layout/client'
import type { MainPanelId } from 'dsh-soc-agent-ui-layout/client'
