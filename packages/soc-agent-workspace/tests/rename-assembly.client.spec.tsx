...
import type { ISession } from 'dsh-soc-agent-session-controller/client'
import type { WorkspaceId } from 'dsh-soc-agent-workspace-controller/client'
...
import { apply, inject } from 'dsh-soc-agent-workspace/client'
