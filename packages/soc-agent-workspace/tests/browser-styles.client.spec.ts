...
const css = readFileSync(resolve(packageRoot, 'src/client/rows/WorkspaceBrowser.module.css'), 'utf8')
const rowsCss = readFileSync(resolve(packageRoot, 'src/client/rows/Rows.module.css'), 'utf8')
