...
export default {
  ...
  resolve: {
    alias: [
      ...
      { find: /^dsh-soc-agent-workspace\/client$/, replacement: resolve(root, 'src/client/index.ts') },
      { find: /^dsh-soc-agent-workspace\/invariant$/, replacement: resolve(root, 'src/invariant.ts') },
      { find: /^dsh-soc-agent-workspace$/, replacement: resolve(root, 'src/index.ts') },
      { find: /^dsh-soc-agent-sidebar\/client$/, replacement: resolve(root, '../soc-agent-sidebar/src/client/index.ts') },
      { find: /^dsh-soc-agent-sidebar\/invariant$/, replacement: resolve(root, '../soc-agent-sidebar/src/invariant.ts') },
      { find: /^dsh-soc-agent-sidebar$/, replacement: resolve(root, '../soc-agent-sidebar/src/index.ts') },
    ],
  },
  test: {
