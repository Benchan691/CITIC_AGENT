/**
 * Package-owned invariant companion for `dsh-soc-agent-workspace`.
 * @module dsh-soc-agent-workspace/invariant
 */
...
const PACKAGE_NAME = 'dsh-soc-agent-workspace'

/** Cordis companion plugin name. */
export const name = 'client-soc-agent-workspace-invariant'
