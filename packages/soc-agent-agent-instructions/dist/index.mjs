...
*
* @module dsh-soc-agent-agent-instructions/config
*/
...
*
* @module dsh-soc-agent-agent-instructions/digest
*/
/**
...
*
* @module dsh-soc-agent-agent-instructions/render
*/
...
const REPLACEMENT_WORKSPACE_CONTEXT_INTRO = "This complete workspace instruction baseline replaces all earlier workspace instruction baselines. " + WORKSPACE_CONTEXT_INTRO;
...
*
* @module dsh-soc-agent-agent-instructions/files
*/
