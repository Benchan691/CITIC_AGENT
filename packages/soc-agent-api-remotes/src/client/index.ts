...
import settingsControllerRemote from 'dsh-soc-agent-api-settings-controller/remote'
...
import fileUploadsRemote from 'dsh-soc-agent-file-upload/remote'
import sessionReferencesRemote from '@deepseek-ai/dsh-session-reference/remote'
import subagentsRemote from '@deepseek-ai/dsh-subagent/remote'
import sessionRemote from 'dsh-soc-agent-session-controller/remote'
import workspaceRemote from 'dsh-soc-agent-workspace-controller/remote'
import workspaceFilesRemote from 'dsh-soc-agent-api-workspace-files/remote'
import type { ClientRemote } from 'dsh-soc-agent-api-gateway/client'

export type { ClientRemote } from 'dsh-soc-agent-api-gateway/client'
export type { PluginInventorySnapshot } from '@deepseek-ai/dsh-host-plugin-inventory/types'
export type {} from '@deepseek-ai/dsh-agent-presets/remote'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from 'dsh-soc-agent-api-settings-controller/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-llm/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-message-feedback/remote'
export type {} from '@deepseek-ai/dsh-command-feedback/remote'
export type {} from 'dsh-soc-agent-file-upload/remote'
export type {} from '@deepseek-ai/dsh-session-reference/remote'
export type {} from '@deepseek-ai/dsh-subagent/remote'
export type * from '@deepseek-ai/dsh-subagent/client'
export type {} from 'dsh-soc-agent-session-controller/remote'
export type * from 'dsh-soc-agent-session-controller/types'
export type {} from 'dsh-soc-agent-workspace-controller/remote'
export type * from 'dsh-soc-agent-workspace-controller/types'
export type {} from 'dsh-soc-agent-api-workspace-files/remote'
export type * from 'dsh-soc-agent-api-workspace-files/types'
export type { SessionJob as JobView } from 'dsh-soc-agent-session-controller/types'
...
export type {
  ...
  StreamChunk,
} from 'dsh-soc-agent-connection/client'
export type {} from 'dsh-soc-agent-api-gateway/client'
...
export type { RemoteHostFacts } from 'dsh-soc-agent-api-gateway/client'
