...
import type {
  IApiClient, RpcError, RpcResult, SessionId, SubagentAddress, JobView, WorkspaceId, FolderId,
...
export class SessionRuntime implements ISessions {
  ...
  /** Permanently delete one session and clear it from the current selection when applicable. */
   ...
   */
  async create(opts: { workspaceId?: WorkspaceId; folderId?: FolderId; cwd?: string; sessionId?: SessionId } = {}): Promise<SessionId> {
