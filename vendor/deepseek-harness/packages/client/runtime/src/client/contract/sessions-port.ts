...
import type { FolderId, SessionId, WorkspaceId } from '@deepseek-ai/dsh-api-remotes/client'
...
export interface SessionsPort {
   ...
   */
  create(opts: { workspaceId?: WorkspaceId; folderId?: FolderId }): Promise<SessionId>
  /** Refresh the session baseline after a sibling domain changes membership. */
