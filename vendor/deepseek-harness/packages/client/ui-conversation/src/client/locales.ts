...
export const zh = {
  ...
  'stats.tokensPerSecond': '模型生成 {throughput} tok/s',
  ...
  'message.tokensPerSecond': '模型生成 {tps} tok/s',
  ...
  'approval.allowSameAction': '允许此操作',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
  'ask.interrupted': '已中断',
...
export const en = {
  ...
  'placeholder.hero': 'Give me some work to do',
  'placeholder.workspace': 'Start a new chat',
  ...
  'stats.tokensPerSecond': 'Model generation {throughput} tok/s',
  ...
  'hero.chooseWorkspace': 'Choose folder (optional)',
  ...
  'message.tokensPerSecond': 'Model generation {tps} tok/s',
  ...
  'approval.allowSameAction': 'Approve same action',
