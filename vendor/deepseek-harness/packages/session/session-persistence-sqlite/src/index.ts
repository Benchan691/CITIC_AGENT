...
export class SqliteSessionPersistence extends SessionPersistence {
  ...
  override deleteSession(id: SessionId): Promise<boolean> {
    return this.store.deleteSession(id)
  }

  override listFolders(): Promise<SessionFolderRecord[]> {
    return this.store.listFolders()
  }

  override createFolder(folder: SessionFolderRecord): Promise<void> {
    return this.store.createFolder(folder)
  }

  override renameFolder(id: FolderId, name: string, description?: string): Promise<void> {
    return this.store.renameFolder(id, name, description)
  }

  override deleteFolder(id: FolderId): Promise<boolean> {
    return this.store.deleteFolder(id)
  }

  override setSessionFolder(id: SessionId, folderId: FolderId): Promise<void> {
    return this.store.setSessionFolder(id, folderId)
  }
