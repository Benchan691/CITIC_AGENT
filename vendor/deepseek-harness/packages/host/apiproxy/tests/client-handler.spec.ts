...
function scriptedApi(overrides: {
  ...
  return {
    ...
    folders: {
      list: r => ok(r, { items: [] }),
      get: r => ok(r, { folder: { folderId: 'general' as never, name: 'General', createdAt: '', updatedAt: '', sessionIds: [] } }),
      create: r => ok(r, { folder: { folderId: 'created' as never, name: r.payload.name, createdAt: '', updatedAt: '', sessionIds: [] } }),
      rename: r => ok(r, { folder: { folderId: r.payload.folderId, name: r.payload.name, createdAt: '', updatedAt: '', sessionIds: [] } }),
      delete: r => ok(r, { deleted: true as const, deletedSessionCount: 0 }),
      moveSessionToFolder: r => ok(r, { folder: { folderId: r.payload.folderId, name: 'General', createdAt: '', updatedAt: '', sessionIds: [r.payload.sessionId] } }),
      listSessionsByFolder: r => ok(r, { items: [] }),
    },
    subagents: {
