...
import {
  ...
  folderListSessionsRequestSchema,
  folderMoveSessionRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'folder.list': { schema: folderListRequestSchema, invoke: (api, r) => api.folders.list(r) },
  'folder.get': { schema: folderGetRequestSchema, invoke: (api, r) => api.folders.get(r) },
  'folder.create': { schema: folderCreateRequestSchema, invoke: (api, r) => api.folders.create(r) },
  'folder.rename': { schema: folderRenameRequestSchema, invoke: (api, r) => api.folders.rename(r) },
  'folder.delete': { schema: folderDeleteRequestSchema, invoke: (api, r) => api.folders.delete(r) },
  'folder.moveSessionToFolder': { schema: folderMoveSessionRequestSchema, invoke: (api, r) => api.folders.moveSessionToFolder(r) },
  'folder.listSessionsByFolder': { schema: folderListSessionsRequestSchema, invoke: (api, r) => api.folders.listSessionsByFolder(r) },
