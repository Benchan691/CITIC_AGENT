...
import type { FoldersApi } from './folders.ts'
...
export interface RpcMethodMap {
  ...
  'folder.list': FoldersApi['list']
  'folder.get': FoldersApi['get']
  'folder.create': FoldersApi['create']
  'folder.rename': FoldersApi['rename']
  'folder.delete': FoldersApi['delete']
  'folder.moveSessionToFolder': FoldersApi['moveSessionToFolder']
  'folder.listSessionsByFolder': FoldersApi['listSessionsByFolder']
