...
export interface WorkspaceApi {
  ...
  /**
   * Removes one Workspace registration. The directory and user files remain;
   * the optional workspace-session-cleanup plugin removes session logs whose
   * canonical cwd belongs to that workspace after the registry commit. An
