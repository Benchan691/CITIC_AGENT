...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('authentication-required'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('admin-authentication-required'), message: z.string(), details: z.object({}) }),
  ...
  z.object({ code: z.literal('workspace-protected'), message: z.string(), details: z.object({ workspaceId: z.string() }) }),
  ...
  z.object({ code: z.literal('folder-name-conflict'), message: z.string(), details: z.object({ name: z.string() }) }),
  z.object({ code: z.literal('folder-invalid-name'), message: z.string(), details: z.object({ name: z.string() }) }),
